...
const crew = ["Duyên", "Long", "Khánh", "Thủy", "Khanh", "Thoại", "Thanh", "Lan Anh", "Lâm", "Tuấn", "Trang"];

// // Cách 1: Sử dụng phương thức join or toString
// function launchShip(crew) {
//     let message = "Chuẩn bị khởi động! Phi hành đoàn gồm: ";
//     message += crew.join(", xx");
//     //or message += crew.toString();
//     message += " sẽ đồng hành cùng bạn trong chuyến phiêu lưu khám phá Vũ trụ K9!";
//     return message;
// }
...
function launchShip2(crew) {
    ...
    console.log(`Chuẩn bị khởi động! Phi hành đoàn gồm: ${memberK9}sẽ đồng hành cùng bạn trong chuyến phiêu lưu khám phá Vũ trụ K9!`);
}
launchShip2(crew);
...
// chính xác, bạn cần viết một hàm calculateDistance để tính toán khoảng cách đến hành
// tinh đó.
...
function calculateDistance(speed, time) {
    let distance = speed * time;   // Chỗ này có thể return speed * time luôn cũng mà không cần khai báo biến distance
    return distance;
}
console.log(`Khoảng cách cần tìm là: ${calculateDistance(1000, 24)} km`);
...
console.log(`Kết quả sau khi chuyển đổi là: ${convertTimeToHex(120)}`);
